...
func TestIPv6AddressStringSemanticEquals(t *testing.T) {
	...
	testCases := map[string]struct {
		currentIpAddr nettypes.IPv6Address
		givenIpAddr   basetypes.StringValuable
		expectedMatch bool
		expectedDiags diag.Diagnostics
	}{
		"not equal - IPv6 address mismatch": {
			currentIpAddr: nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:0"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:1"),
			expectedMatch: false,
		},
		"not equal - IPv6 address compressed mismatch": {
			currentIpAddr: nettypes.NewIPv6AddressValue("FF01::"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("FF01::1"),
			expectedMatch: false,
		},
		"not equal - IPv4-Mapped IPv6 address mismatch": {
			currentIpAddr: nettypes.NewIPv6AddressValue("::FFFF:192.168.255.255"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("::FFFF:192.168.255.254"),
			expectedMatch: false,
		},
		"semantically equal - byte-for-byte match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:0"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:0"),
			expectedMatch: true,
		},
		"semantically equal - IPv4-Mapped byte-for-byte match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("::FFFF:192.168.255.255"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("::FFFF:192.168.255.255"),
			expectedMatch: true,
		},
		"semantically equal - compressed all zeroes match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:0"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("::"),
			expectedMatch: true,
		},
		"semantically equal - compressed all leading zeroes match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("2001:0DB8:0000:0000:0008:0800:0200C:417A"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("2001:DB8::8:800:200C:417A"),
			expectedMatch: true,
		},
		"semantically equal - start compressed match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("::101"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("0:0:0:0:0:0:0:101"),
			expectedMatch: true,
		},
		"semantically equal - middle compressed match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("2001:DB8::8:800:200C:417A"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("2001:DB8:0:0:8:800:200C:417A"),
			expectedMatch: true,
		},
		"semantically equal - end compressed match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("FF01:0:0:0:0:0:0:0"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("FF01::"),
			expectedMatch: true,
		},
		"semantically equal - IPv4-Mapped compressed match": {
			currentIpAddr: nettypes.NewIPv6AddressValue("0:0:0:0:0:FFFF:192.168.255.255"),
			givenIpAddr:   nettypes.NewIPv6AddressValue("::FFFF:192.168.255.255"),
			expectedMatch: true,
		},
			...
			expectedDiags: diag.Diagnostics{
				diag.NewErrorDiagnostic(
					...
					"An unexpected value type was received while performing semantic equality checks. "+
						...
						"Expected Value Type: nettypes.IPv6Address\n"+
...
func TestIPv6AddressValueIPv6Address(t *testing.T) {
	...
	testCases := map[string]struct {
		ipValue        nettypes.IPv6Address
		expectedIpAddr netip.Addr
		expectedDiags  diag.Diagnostics
	}{
		"IPv6 address value is null ": {
			ipValue: nettypes.NewIPv6AddressNull(),
			expectedDiags: diag.Diagnostics{
				diag.NewErrorDiagnostic(
		...
		"IPv6 address value is unknown ": {
			ipValue: nettypes.NewIPv6AddressUnknown(),
			expectedDiags: diag.Diagnostics{
				diag.NewErrorDiagnostic(
					"IPv6Address ValueIPv6Address Error",
		...
		"valid IPv6 address ": {
			ipValue:        nettypes.NewIPv6AddressValue("2001:DB8::8:800:200C:417A"),
